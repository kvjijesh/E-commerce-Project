...
router.get('/product/edit/:id',auth.isAdminLogin,productController.editProductLoad)
router.post('/product/edit/:id',store.array('image',5),productController.updateProduct)
router.get('/product/addproduct',auth.isAdminLogin,productController.addProductLoad)
//router.post('/product/addproduct',store.single('image'),productController.addProduct)
router.post('/product/addproduct',store.array('images',5),productController.addProduct)
router.get('/category',auth.isAdminLogin,categoryController.getCategoryList)
router.get('/category/addcategory',auth.isAdminLogin,categoryController.addCategoryLoad)
router.post('/category/addcategory',store.single('image'),categoryController.createCategory)
router.get('/category/edit/:id',auth.isAdminLogin,categoryController.editCategoryLoad)
router.post('/category/edit/:id',store.single('image'),categoryController.updateCategory)
router.get('/delete/:id',auth.isAdminLogin,categoryController.deleteCategory)
router.get('/product/block/:id',auth.isAdminLogin,productController.blockProduct)
